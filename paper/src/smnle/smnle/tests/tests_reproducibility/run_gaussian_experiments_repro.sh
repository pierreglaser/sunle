...
n_observations=1
PYTHONPATH="../../" python3 ../../scripts/generate_obs.py gaussian --n_observations $n_observations
...
PYTHONPATH="../../" python3 ../../scripts/train_net.py SSM gaussian --nets_folder net-SSM --epochs 50 --lr_data 0.001 --lr_theta 0.001 \
    --update --bn_mom 0.9 --epochs_before_early_stopping 10 --epochs_test_interval 10
# 
...
for ((j=0;j<${#METHODS[@]};++j)); do
    ...
    for ((k=0;k<${#inn_steps_values[@]};++k)); do
        ...
        PYTHONPATH="../../" python3 ../../scripts/inferences.py ${METHOD} ${model} --burnin $burnin --n_samples $n_samples \
