...
mkdir -p results
mkdir -p results/two_moons
mkdir -p results/two_moons/ABC-FP
mkdir -p results/two_moons/ABC-SM
mkdir -p results/two_moons/ABC-SSM
mkdir -p results/two_moons/Exc-SM
mkdir -p results/two_moons/Exc-SM/10_inn_steps
mkdir -p results/two_moons/Exc-SM/30_inn_steps
mkdir -p results/two_moons/Exc-SM/100_inn_steps
mkdir -p results/two_moons/Exc-SM/200_inn_steps
mkdir -p results/two_moons/Exc-SSM
mkdir -p results/two_moons/Exc-SSM/10_inn_steps
mkdir -p results/two_moons/Exc-SSM/30_inn_steps
mkdir -p results/two_moons/Exc-SSM/100_inn_steps
mkdir -p results/two_moons/Exc-SSM/200_inn_steps
mkdir -p results/two_moons/net-FP
mkdir -p results/two_moons/net-SM
mkdir -p results/two_moons/net-SSM
mkdir -p results/two_moons/observations
mkdir -p results/two_moons/PMC-RE
mkdir -p results/two_moons/PMC-SL


# GENERATE OBSERVATIONS AND EXACT POSTERIORS

n_observations=2
python3 scripts/generate_obs.py two_moons --n_observations $n_observations

# TRAIN THE NNs
python3 scripts/train_net.py SSM two_moons --nets_folder net-SSM --epochs 500 --lr_data 0.01 --lr_theta 0.01 \
