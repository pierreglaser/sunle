...
"""
    ...
    for r in range(num_rounds):
        ...
        print(f'inference for round {r} finished')
        print('creating single round results summary and appending it to the return object...')
        single_round_result = {"data": (transforms.inv(theta), x), "posterior": posterior}
        ...
        if cache_inf is not None:
            ...
            with open(save + os.sep + str(cache_inf) + "_single_round_results.pkl", "wb") as f:
    ...
    return posteriors, samples, num_simulations, single_round_results
